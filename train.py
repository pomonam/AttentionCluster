# Copyright 2018 Google Inc., Juhan All Rights Reserved.
#
            ...
            try:
                ...
                while (not sv.should_stop()) and (not self.max_steps_reached):
                    ...
                    if self.is_master and global_step_val % 10 == 0 and self.train_dir:
                        ...
                        hit_at_one = eval_utils.calculate_hit_at_one(predictions_val, labels_val)
                        perr = eval_utils.calculate_precision_at_equal_recall_rate(predictions_val,
                                                                                  labels_val)
                        gap = eval_utils.calculate_gap(predictions_val, labels_val)
